...
docker run --rm --stop-timeout 60 --privileged --hostname lab3 -v lab3:/lab/ -v lab_cache:/var/containers/cache/ -p 9870:9870 -p 19888:19888 -it {{ page.meta.docker_image }}
```
