...
docker run --rm --privileged --hostname lab6 -v lab6:/lab/ -v lab_cache:/var/containers/cache/ -p 4040:4040 -p 8000:8000 -p 8080:8080 -p 8888:8888 -p 9870:9870 {{ page.meta.docker_image }}
```
