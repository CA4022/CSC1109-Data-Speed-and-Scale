...
docker run --rm --stop-timeout 60 --privileged --hostname lab2 -v lab2:/lab/ -v lab_cache:/var/containers/cache/ -p 9870:9870 -p 10000:10000 -p 10002:10002 -it {{ page.meta.docker_image }}
```
